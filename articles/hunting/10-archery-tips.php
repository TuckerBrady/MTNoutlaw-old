...
<head>
    ...
    ================================================== -->
    <meta charset="utf-8">
    <title>10 Archery Tips: Trigger Panic - Hunting</title>
    <meta name="keywords" content="Hunting, Fishing, Camping, Outdoors">
    <meta name="description" content="10 Archery Tips To Improve Accuracy">
        ...
        <article class="row format-standard">
            ...
            <div class="s-content__header col-full">
                <h1 class="s-content__header-title">
                    10 Archery Tips To Help Improve Your Accuracy: Trigger Panic.
                </h1>
                <ul class="s-content__header-meta">
                    <li class="date">June 1, 2020</li>
                    <li class="cat">
                        In
