...
<head>
    ...
    ================================================== -->
    <meta charset="utf-8">
    <title>Articles - MTN Outlaws</title>
            ...
            <div class="masonry">
                ...
                <article class="masonry__brick entry format-standard" data-aos="fade-up">
                    ...
                    <div class="entry__thumb">
                        <a href="single-standars.php" class="entry__thumb-link">
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            ...
                            <div class="entry__date">
                                <a href="single-standars.php">December 15, 2017</a>
                            </div>
                            <h1 class="entry__title"><a href="single-standars.php">Just a Standard Format Post.</a></h1>
                        ...
                        <div class="entry__meta">
                            <span class="entry__meta-links">
                                <a href="articles.php">Design</a> 
                                <a href="articles.php">Photography</a>
                            </span>
                        </div>
                    </div>
                ...
                <article class="masonry__brick entry format-standard">
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            ...
                            <h1 class="entry__title"><a href="single-standars.php">10 Interesting Facts About Caffeine.</a></h1>
                ...
                <article class="masonry__brick entry format-standard" data-aos="fade-up">
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            ...
                            <div class="entry__date">
                                <a href="single-standars.php">December 10, 2017</a>
                            </div>
                            <h1 class="entry__title"><a href="single-standars.php">No Sugar Oatmeal Cookies.</a></h1>
                ...
                <article class="masonry__brick entry format-standard" data-aos="fade-up">
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            ...
                            <h1 class="entry__title"><a href="single-standars.php">Visiting Theme Parks Improves Your Health.</a></h1>
                ...
                <article class="masonry__brick entry format-video" data-aos="fade-up">
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            ...
                            <div class="entry__date">
                                <a href="single-vides.php">December 10, 2017</a>
                            </div>
                            <h1 class="entry__title"><a href="single-vides.php">Key Benefits Of Family Photography.</a></h1>
                ...
                <article class="masonry__brick entry format-gallery" data-aos="fade-up">
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            ...
                            <div class="entry__date">
                                <a href="single-gallers.php">December 10, 2017</a>
                            </div>
                            <h1 class="entry__title"><a href="single-gallers.php">Workspace Design Trends and Ideas.</a></h1>
                        ...
                        <div class="entry__meta">
                            <span class="entry__meta-links">
                                <a href="articles.php">Work</a> 
                                <a href="articles.php">Management</a>
                            </span>
                        </div>
                    </div>
                ...
                <article class="masonry__brick entry format-audio" data-aos="fade-up">
                    ...
                    <div class="entry__thumb">
                        <a href="single-audis.php" class="entry__thumb-link">
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            ...
                            <div class="entry__date">
                                <a href="single-audis.php">December 10, 2017</a>
                            </div>
                            <h1 class="entry__title"><a href="single-audis.php">What Your Music Preference Says About You and Your Personality.</a></h1>
                        ...
                        <div class="entry__meta">
                            <span class="entry__meta-links">
                                <a href="articles.php">Music</a> 
                                <a href="articles.php">Lifestyle</a>
                            </span>
                        </div>
                    </div>
                ...
                <article class="masonry__brick entry format-standard" data-aos="fade-up">
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            ...
                            <h1 class="entry__title"><a href="single-standars.php">Create Meaningful Family Moments.</a></h1>
                        ...
                        <div class="entry__meta">
                            <span class="entry__meta-links">
                                <a href="articles.php">Family</a>
                                <a href="articles.php">Relationship</a>
                            </span>
                        </div>
                    </div>
                ...
                <article class="masonry__brick entry format-standard" data-aos="fade-up">
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            ...
                            <h1 class="entry__title"><a href="single-standars.php">Throwback To The Good Old Days.</a></h1>
                ...
                <article class="masonry__brick entry format-standard" data-aos="fade-up">
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            ...
                            <h1 class="entry__title"><a href="single-standars.php">Just Another  Standard Format Post.</a></h1>
                ...
                <article class="masonry__brick entry format-standard" data-aos="fade-up">
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            ...
                            <h1 class="entry__title"><a href="single-standars.php">Planning Your First Trip to Sydney.</a></h1>
                        ...
                        <div class="entry__meta">
                            <span class="entry__meta-links">
                                <a href="articles.php">Travel</a> 
                                <a href="articles.php">Vacation</a>
                            </span>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-two md-four mob-full s-footer__sitelinks">
                    ...
                    <ul class="s-footer__linklist">
                        ...
                        <li><a href="abous.php">About</a></li>
